...
#initial-content .initial-nav{display:flex;align-items:center;gap:10px;background:#f3eeff;min-height:58px;padding:10px max(16px,calc((100vw - 1392px)/2));border-bottom:2px solid #c9963f}#initial-content .initial-nav img{border-radius:10px}#initial-content .initial-nav strong{font:700 16px/1.25 'Playfair Display',Georgia,serif}#initial-content .initial-nav small{display:block;color:#9333ea;letter-spacing:2px;text-transform:uppercase;font-size:10px;font-weight:700;margin-top:4px}
#initial-content .initial-hero{padding:80px 24px;min-height:70vh;background:radial-gradient(circle at 85% 5%,#9333ea44,transparent 45%),linear-gradient(135deg,#0a001e,#1a0533 35%,#2d0f6b 65%,#1a0533);color:#fff;display:flex;align-items:center}#initial-content .initial-inner{width:100%;max-width:1280px;margin:auto;display:grid;grid-template-columns:1fr 1fr;gap:60px;align-items:center}#initial-content .initial-copy{min-width:0}#initial-content .initial-badge{display:inline-block;color:#e8c97a;border:1px solid #c9963f55;background:#c9963f20;border-radius:30px;font-size:13px;letter-spacing:2px;text-transform:uppercase;padding:5px 16px;margin:0 0 20px;max-width:100%}#initial-content h1{font:700 clamp(32px,5vw,64px)/1.1 'Playfair Display',Georgia,serif;margin:0 0 20px;overflow-wrap:anywhere}#initial-content h1 span{display:block}#initial-content .initial-highlight{padding-bottom:.2em;margin-bottom:-.2em;background:linear-gradient(135deg,#c084fc,#e8c97a);background-clip:text;-webkit-background-clip:text;color:transparent}#initial-content .initial-intro{max-width:480px;margin:0 0 32px;color:#ffffffb8;font-size:16px;line-height:1.85;white-space:pre-line}#initial-content .initial-actions{display:flex;flex-wrap:wrap;gap:12px}#initial-content .initial-actions a{padding:10px 32px;background:linear-gradient(135deg,#c9963f,#e8c97a);border-radius:8px;color:#1a0533;text-decoration:none;font-size:15px;font-weight:600;min-height:44px;line-height:1.4}#initial-content .initial-actions a+ a{background:#ffffff14;border:1px solid #ffffff33;color:white;padding-inline:20px}#initial-content .initial-page{padding:48px 24px;max-width:1200px;margin:auto}#initial-content .initial-page h1{font-size:clamp(28px,5vw,48px)}#initial-content .initial-page p{color:#6b7280}#initial-content .initial-blog{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:24px}#initial-content article{padding:24px;border:1px solid #eee;border-radius:16px}#initial-content article h2{font:700 24px 'Playfair Display',Georgia,serif}
